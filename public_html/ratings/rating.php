...
function rating($voted=true) {
  ...
  $ratingHTML = '<ol class="rating show-current"><li>5</li><li>4</li><li>3</li><li>2</li><li>1</li><li class="current"><span style="width:'.$pr.'%"></span></li></ol> <span class="rating-text">('.$total_text.', в среднем: '.($abs).' из 5)</span> <div class="rating-info" id="rating-info"></div>';
